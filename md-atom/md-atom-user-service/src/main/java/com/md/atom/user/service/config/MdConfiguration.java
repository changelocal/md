package com.md.atom.user.service.config;
...
public class MdConfiguration implements WebMvcConfigurer, EnvironmentAware {
	...
	public FilterRegistrationBean<Filter> responseWrapFilter() {
		...
		registration.addUrlPatterns("/adminuser/*");
		registration.addUrlPatterns("/brand/*");
		...
		registration.addUrlPatterns("/searchRecord/*");
		registration.addUrlPatterns("/brandRefreshRecord/*");
		return registration;
	}
