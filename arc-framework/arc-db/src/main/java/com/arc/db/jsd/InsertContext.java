...
import com.arc.db.jsd.clause.ColumnsClause;
import com.arc.db.jsd.clause.InsertClause;
import com.arc.db.jsd.clause.InsertEndClause;
import com.arc.db.jsd.clause.ValuesClause;
    ...
    public InsertResult result(boolean returnKeys) {
        ...
        try {
            ...
            if (statsManager.isReportEnabled()) {
                stats = StatsUtil.buildStats(this.manager, conn, sql, result.getArgs());
            }
